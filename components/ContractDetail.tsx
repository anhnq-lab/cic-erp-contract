                    ...
                    return (
                      <tr key={idx} className="group hover:bg-slate-50 dark:hover:bg-slate-800/20">
                        ...
                        <td className="px-4 py-3 text-right text-rose-500 font-bold align-top">
                          <Tooltip
                            content={
                              item.directCostDetails && item.directCostDetails.length > 0 ? (
                                <div className="bg-slate-900 text-white text-xs rounded-2xl p-4 shadow-xl shadow-indigo-500/10 border border-slate-700 min-w-[200px]">
                          ...
                          >
                            <div className={`border-b border-dashed ${item.directCostDetails?.length ? 'border-rose-300/50 cursor-help' : 'border-transparent'} w-fit ml-auto pb-0.5`}>
