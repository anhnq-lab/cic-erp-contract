...
import {
  ...
  Crown, ShieldCheck, Send, XCircle, RotateCcw,
  Bookmark, Network, Paperclip
} from 'lucide-react';
...
import { TaskApprovalDialogs } from './task-detail/TaskApprovalDialogs';
import {
  DatePickerField, LinkItem, PersonBadge, TagInputWithAutocomplete,
  PersonalTagInput, ChecklistRow, HistoryTab, PRIORITIES,
  type PersonInfo, type ChecklistItem,
} from './TaskDetailSubComponents';
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            {/* LIÊN KẾT */}
            {bottomTab === 'links' && (
              <TaskLinksTab task={task} links={links} setLinks={setLinks} profile={profile} bufferChange={bufferChange} />
            )}
