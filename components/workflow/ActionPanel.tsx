...
export const ActionPanel: React.FC<Props> = ({
    ...
    return (
        <div className="flex gap-2">
            ...
            {isEditing && (
                <div className="flex gap-2">
                    <button onClick={() => setIsEditing(false)} className="px-4 py-2 text-slate-600 hover:bg-slate-50 rounded-lg text-sm font-medium transition-colors">Hủy</button>
            ...
            {showApproveUnit && (
                <div className="flex gap-2 items-center bg-amber-50 rounded-lg p-1 pr-2 border border-amber-100">
            ...
            {showApproveFinance && (
                <div className="flex gap-2 items-center bg-indigo-50 rounded-lg p-1 pr-2 border border-indigo-100">
            ...
            {showApproveBoard && (
                <div className="flex gap-2 items-center bg-purple-50 rounded-lg p-1 pr-2 border border-purple-100">
            ...
            {canAdjustCost && (
                <div className="ml-2 pl-2 border-l border-slate-200">
                    <button
                        ...
                        className="px-3 py-2 bg-emerald-50 text-emerald-700 rounded-lg hover:bg-emerald-100 font-medium text-xs flex items-center gap-1 border border-emerald-200 transition-colors"
                    >
