...
const RESOURCES: PermissionResource[] = ['contracts', 'employees', 'units', 'customers', 'products', 'payments', 'settings', 'permissions', 'reports', 'news', 'projects', 'requests', 'leaves', 'recruitment', 'tasks', 'analytics'];
