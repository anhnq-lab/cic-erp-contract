          ...
          {!isEditing && (
            <button
              onClick={() => {
                ...
                setManualValue(150000000);
                setLineItems([
                  { id: 'sample-1', name: 'Tư vấn BIM Setup', quantity: 1, supplier: '', inputPrice: 0, outputPrice: 50000000, directCosts: 0 },
                  { id: 'sample-2', name: 'Đào tạo Revit Arch', quantity: 2, supplier: 'CTV_ABC', inputPrice: 5000000, outputPrice: 15000000, directCosts: 10000000, directCostDetails: [{ name: 'Thuê giảng viên', amount: 10000000 }] }
                ]);
                setAdminCosts({
